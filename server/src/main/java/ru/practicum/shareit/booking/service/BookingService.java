...
public interface BookingService {
    ...
    List<BookingDtoOut> getUserBookings(Long userId, State state, Long from, Integer size);

    List<BookingDtoOut> getOwnerBookings(Long ownerId, State state, Long from, Integer size);
}
